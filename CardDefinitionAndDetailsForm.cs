...
{
    public partial class CardDefinitionAndDetailsForm : Form
    {
        ...
        public CardDefinitionAndDetailsForm(OwnerOptionForm OwnerOptionForm)
        {
            InitializeComponent();
            this.OwnerOptionForm = OwnerOptionForm;
        }

        private void CardDefinitionAndDetailsForm_Load(object sender, EventArgs e)
        {
